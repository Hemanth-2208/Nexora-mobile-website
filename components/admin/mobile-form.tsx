...
export default function MobileForm() {
  ...
  const onSubmit = async (values: MobileFormValues) => {
    setSubmitError(null);
    try {
      ...
      const { error } = await supabase.from("mobiles").insert([
        {
      ...
      console.error("Unexpected submission failure:", err);
  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 max-w-[1100px] mx-auto pb-24">
        ...
        {/* Global Submission Error Panel */}
        {submitError && (
          <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-2xl text-rose-600 dark:text-rose-450 text-xs font-semibold flex items-start gap-2.5">
            <AlertCircle className="size-4 shrink-0 mt-0.5" />
            <div className="flex-1">
              <span className="font-bold block mb-0.5">Failed to save mobile</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* LEFT: Specifications Details (lg:col-span-7) */}
            ...
            <div className="p-6 sm:p-8 bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-800/85 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.003)] space-y-5">
              ...
              <div className="flex flex-col gap-1.5 pt-2">
                ...
                <textarea
                  id="description"
                  rows={4}
                  placeholder="Provide a premium description detailing design, performance, and key highlights..."
                  className={cn(
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    id="display"
                    type="text"
                    placeholder="e.g. 6.7” Super Retina XDR"
                    className={cn(
                      "w-full px-4 py-3 bg-zinc-50/50 dark:bg-zinc-950/20 border border-zinc-200/80 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-100 placeholder-zinc-400 text-zinc-900 dark:text-zinc-300",
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    id="camera"
                    type="text"
                    placeholder="e.g. 48MP Main + 12MP Telephoto"
                    className={cn(
                      "w-full px-4 py-3 bg-zinc-50/50 dark:bg-zinc-950/20 border border-zinc-200/80 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-100 placeholder-zinc-400 text-zinc-900 dark:text-zinc-300",
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    id="battery"
                    type="text"
                    placeholder="e.g. 4441 mAh, 25W Fast Charge"
                    className={cn(
                      "w-full px-4 py-3 bg-zinc-50/50 dark:bg-zinc-950/20 border border-zinc-200/80 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-100 placeholder-zinc-400 text-zinc-900 dark:text-zinc-300",
          ...
          {/* RIGHT: Images, Pricing, & Visibility (lg:col-span-5) */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    placeholder="89999"
                    className={cn(
                      "w-full px-4 py-3 bg-zinc-50/50 dark:bg-zinc-950/20 border border-zinc-200/80 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-100 placeholder-zinc-450 text-zinc-900 dark:text-zinc-300",
